...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'fname'                 => 'نام',
        'lname'                 => 'نام خانوادگی',
        'shenasname'            =>'اسکن صفحه اصلی شناسنامه',
        'cart'                  =>'اسکن کارت ملی',
        'rooznamepic'           =>'اسکن روزنامه رسمی',
        'restShiftFirstTimeCheck'=>'زمان شیف کاری خالی است',
        'title_weeklyshift'      =>'شیفت هفتهگی',
        'min_work'               =>'حداقل زمان کاری',
